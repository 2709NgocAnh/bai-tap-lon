...
<div class="navigation">
    <div class="blackRum">
        	<span class="home">
            	<a href="https://localhost/webbanhang/">Trang chủ</a>
                 ›
            </span><!--end home-->
        <span class="home">
            	<?php
...
<section class="product_d content_ld">
    <div class="detailP">
        ...
        <aside class="desProduct">
            ...
            <div class="proDha">
                <a href="add-cart.php?id=<?php echo $id ?>">
                    <div class="btDah">
                        <span class="bttOp" style="font-size: 20px; padding-top:10px;">THÊM VÀO GIỎ</span>
                    </div><!--end btDah-->
                </a>
                <div class="yctv"><a href="https://www.facebook.com/CoktailDail/" target="_blank"> YÊU CẦU TƯ VẤN</a> </div><!--end yctv-->
            </div><!--end proDha-->
            <div class="goituvan">
        ...
        <aside class="ckProduct">
            ...
            <div class="deCk deCkTtct">
                ...
                <span class="ttCK">Nhận hàng trong vòng <b>12 giờ</b> tại HCM và <b>48 giờ</b> tại các tỉnh thành khác (Thanh toán Tiền mặt)</span><!--end ttCK-->
            </div><!--deCk deCkTtct-->
